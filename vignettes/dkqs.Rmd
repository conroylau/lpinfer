...
cone-tightening procedure of @dkqs2018. Based on the test statistic, this
package can compute the *p*-value, construct confidence intervals and estimate
the bounds subject to shape constraints. 
...
`estimate` option for the package is available for the user.
